...
Add the following screenshots for the README:

- `dashboard.png` — Full dashboard overview (board + settings panel)
- `arrows.png` — Best-move arrows overlaid on a chess.com or lichess game
